    ...
    <div class="bg-white rounded-[12px] border border-[#e2e6ea] p-6">
        <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data">
            ...
            <div class="flex gap-3 mt-6 pt-5 border-t border-[#eef1f4]">
                <button type="submit" class="px-6 py-[11px] rounded-[9px] bg-[#1fa5c4] text-white text-[14px] font-bold border-0 cursor-pointer font-sans hover:bg-[#178ba6] transition-colors duration-150">登録する</button>
